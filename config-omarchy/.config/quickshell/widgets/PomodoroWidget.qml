...
PanelWindow {
    ...
    function playBeep() {
        Quickshell.execDetached(["bash", "-lc", "if command -v pw-play >/dev/null 2>&1; then " + "  pw-play /usr/share/sounds/freedesktop/stereo/complete.oga 2>/dev/null || " + "  pw-play /usr/share/sounds/freedesktop/stereo/bell.oga 2>/dev/null; " + "elif command -v paplay >/dev/null 2>&1; then " + "  paplay /usr/share/sounds/freedesktop/stereo/complete.oga 2>/dev/null || " + "  paplay /usr/share/sounds/freedesktop/stereo/bell.oga 2>/dev/null; " + "fi"]);
    }
            ...
            ColumnLayout {
                ...
                RowLayout {
                    ...
                    Rectangle {
                        ...
                        height: 26
                        radius: 8
                        color: root.running ? Qt.alpha(cAccent, 0.38) : Qt.alpha(cAccent, 0.26)
                        border.color: root.running ? Qt.alpha(cAccent, 0.75) : Qt.alpha(cAccent, 0.55)
                        border.width: 1
