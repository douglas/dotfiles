...
PanelWindow {
    ...
    function save() {
        ...
        Quickshell.execDetached(["bash", "-lc", "mkdir -p " + (Quickshell.env("HOME") || "") + "/.config/quickshell; " + "printf '%s' '" + payload + "' > " + dataFile]);
    }
    ...
    function syncPositionFromSettings() {
        ...
        if (typeof settings.todoWidgetPosX === "number")
            posX = settings.todoWidgetPosX;

        if (typeof settings.todoWidgetPosY === "number")
            posY = settings.todoWidgetPosY;
            ...
            Column {
                ...
                Item {
                    ...
                    Rectangle {
                        ...
                        border.color: showInput ? Qt.alpha(cAccent, 0.35) : Qt.alpha(cFg, 0.1)
                        border.width: 0
                ...
                Rectangle {
                    ...
                    border.color: Qt.alpha(cAccent, 0.3)
                    border.width: 1
                    clip: true
                ...
                Flickable {
                    ...
                    width: parent.width
                    height: Math.max(80, root.contentH - (28 + 1 + 8 + (showInput ? 32 + 8 : 0) + 10 + (root.items.some((i) => {
                        return i.done;
                    }) ? 22 : 0)))
                    clip: true
                    contentWidth: width
                        ...
                        Repeater {
                            ...
                            Item {
                                ...
                                Rectangle {
                                    ...
                                    border.color: todoRow.item.done ? cAccent : Qt.alpha(cFg, 0.2)
                                    border.width: 1
